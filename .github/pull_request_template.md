...
`npm run check:facts` enforces most of this. The guard cannot judge whether a
new number is true — that part is on the author.

- [ ] Every new figure traces to a primary source, or is labelled as a target
