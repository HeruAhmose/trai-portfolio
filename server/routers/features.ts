...
const SEARCH_CONTENT = [
  {
    ...
    description:
      "Quantum superposition, Bloch sphere, quantum circuit simulation, qubit entanglement",
  ...
  },
  {
    ...
    description:
      "Multi-modal energy harvesting, piezoelectric, spin-Seebeck effect, self-powered devices",
  ...
  },
  {
    ...
    description:
      "AMC manufacturing, fiber preparation, pyrolysis, composite assembly, 7-step process",
  ...
  },
  {
    ...
    title: "Applications",
    description:
      "Biomedical implants, DNA storage, environmental sensors, wearable generators, integrated systems",
    tags: ["applications", "biomedical", "sensors", "wearable"],
    url: "/applications",
    icon: "🔧",
  },
  {
    ...
    description:
      "TechBridge Collective, digital access, workforce development, North Carolina, hub network",
    tags: ["community", "techbridge", "digital access", "workforce"],
    url: "/community",
    icon: "🤝",
  },
  {
  ...
  },
  {
    ...
    description:
      "Career milestones, achievements, professional journey, research history",
    tags: ["career", "timeline", "history", "milestones"],
    url: "/career-timeline",
    icon: "⏳",
  },
  {
    ...
    description: "3D project cards, portfolio projects, technology showcase",
    tags: ["projects", "portfolio", "gallery"],
    url: "/projects",
    icon: "🎨",
  },
  {
    ...
    description:
      "Quantum computing visualization, neural networks, physics simulation, 3D data viz",
    tags: ["advanced", "features", "visualization", "3d", "neural"],
  ...
  },
  {
    id: "queen-califia",
    type: "project",
    title: "QueenCalifia CyberAI",
    description:
      "Cybersecurity AI platform, threat detection, quantum-ready encryption, sovereign security",
    tags: ["cybersecurity", "ai", "quantum", "security"],
  ...
  },
  {
    ...
    description:
      "Digital equity initiative, H.K. AI navigator, community technology access",
    tags: ["techbridge", "digital equity", "community", "ai"],
    url: "/community",
    icon: "🌉",
  },
  {
    ...
    description:
      "Architecture-Driven Emergent Behavior in Multi-Component Composites, 2026",
  ...
  },
  {
    ...
    title: "H.K. Assistant",
    description:
      "AI triage assistant, material science guidance, cybersecurity support, community navigation",
    tags: ["ai", "assistant", "hk", "chat"],
    url: "/",
    icon: "🤖",
  },
  {
    ...
    description:
      "MediaPipe hand tracking, swipe navigation, pinch zoom, gesture-based interaction",
    tags: ["gesture", "mediapipe", "interaction", "hands"],
    url: "/gesture-control",
    icon: "✋",
  },
  {
    ...
    description:
      "Speech recognition, voice navigation, spoken commands, accessibility",
    tags: ["voice", "speech", "commands", "accessibility"],
    url: "/sound-preferences",
    icon: "🎙️",
  },
  {
    ...
    title: "Sound & Audio",
    description:
      "Spatial audio, sound-reactive effects, audio preferences, immersive sound",
    tags: ["audio", "sound", "spatial", "immersive"],
    url: "/sound-preferences",
    icon: "🔊",
  },
  {
    ...
    description:
      "Analytics, user metrics, recommendation tracking, performance monitoring",
  ...
  getApiDocs: publicProcedure.query(() => ({
    ...
    endpoints: [
      ...
      },
      {
        path: "hk.query",
        method: "mutation",
        description: "Query H.K. AI Assistant",
        auth: "none",
