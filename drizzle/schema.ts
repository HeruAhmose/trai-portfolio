...
export const themePreferences = mysqlTable('themePreferences', {
  ...
  variant: mysqlEnum('variant', ['dark-cyberpunk', 'light-neon', 'high-contrast', 'minimal'])
  ...
  accentColor: varchar('accentColor', { length: 7 }).default('#ff00ff').notNull(), // Hex color
...
export const notifications = mysqlTable('notifications', {
  ...
  type: mysqlEnum('type', ['achievement', 'milestone', 'system', 'engagement', 'ai_insight']).notNull(),
  title: varchar('title', { length: 255 }).notNull(),
  message: text('message').notNull(),
  data: json('data'),
