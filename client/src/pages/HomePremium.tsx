...
export default function HomePremium() {
  ...
  useEffect(() => {
    ...
    const drawPremiumParticles = (ctx: CanvasRenderingContext2D, time: number) => {
    ...
    const drawPremiumGradientOrbs = (ctx: CanvasRenderingContext2D, time: number) => {
      // Orb 1 - Gold
  ...
  return (
    <div ref={containerRef} className="relative w-full min-h-screen overflow-hidden bg-color-primary">
      ...
      >
        ...
        <motion.div className="text-center max-w-4xl mx-auto" variants={itemVariants}>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Advanced research in quantum computing, materials science, and autonomous systems.
            Pioneering the future of technology through innovation and sovereign intelligence.
          </motion.p>
          ...
          {[
            {
              ...
              description: 'Advanced quantum algorithms and hardware optimization',
            },
            {
              icon: Globe,
