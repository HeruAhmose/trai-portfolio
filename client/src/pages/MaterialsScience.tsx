      ...
      <div className="relative z-[1]">
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <p className="text-xl text-foreground/80 max-w-2xl">
              ...
              · 25 application claims · Confirmation #6305 · Micro Entity.
        ...
        <section className="container mx-auto px-4 py-8">
          <div className="flex gap-4 flex-wrap border-b border-border pb-4">
            {[
              { id: "visualization", label: "PROPOSED ARCHITECTURE" },
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                  ...
                  {[
                    {
                      name: "Hemp-Carbon Matrix",
                      color: "#ffd700",
                      role: "Pyrolysis 700–1400°C · Conductivity 10²–10⁶ S/m",
                    },
                    {
                      name: "Quartz SiO₂",
                      color: "#00d9ff",
                      role: "Piezoelectric · 15–45% composition",
                    },
                    {
                      name: "Tourmaline",
                      color: "#ff00ff",
                      role: "Dual piezo/pyro · 3–25% composition",
                    },
                    {
                      name: "Magnetite Fe₃O₄",
                      color: "#00ff88",
                      role: "Ferrimagnetic · 2–20% composition",
                    },
                  ].map((constituent, idx) => (
                    <motion.div
                      key={idx}
              ...
              >
                <h3 className="font-bold text-foreground mb-4">
                  APPLICATION TARGETS · NOT MEASURED
                </h3>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-lime-500 font-bold">
                      Piezoelectric application range:
                    </p>
                    <p className="text-foreground/80">50–500 μW/cm²</p>
                  </div>
                  <div>
                    <p className="text-lime-500 font-bold">
                      Thermoelectric application range:
                    </p>
                    <p className="text-foreground/80">ZT 1.0–2.5</p>
                  </div>
                  <div>
                    <p className="text-lime-500 font-bold">
                      Spin-Seebeck application enhancement:
                    </p>
                    <p className="text-foreground/80">+40–60%</p>
                  </div>
                  <div>
                    <p className="text-lime-500 font-bold">
                      Combined application range:
                    </p>
                    <p className="text-foreground/80">80–800 μW/cm²</p>
                  </div>
                </div>
                <p className="text-foreground/80 leading-relaxed mt-4">
                  Quantum-sensing hypothesis: rare-earth candidates (Eu³⁺, Nd³⁺,
                  Er³⁺, Yb³⁺, Ce³⁺) with a target coherence T₂ {">"}500 ns at
                  300 K. This target and self-powered sensing direction are not
        ...
        <section className="container mx-auto px-4 py-16 border-t border-border">
          ...
          >
            {[
              { label: "APPLICATION CLAIMS", value: "25" },
              { label: "CONSTITUENT CLASSES", value: "5" },
              { label: "PROPOSED TRANSDUCTION MODES", value: "4" },
              { label: "PROPOSED PROCESS STEPS", value: "7" },
            ].map((metric, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                {metric.label === "APPLICATION CLAIMS" && (
                  <p className="text-xs text-cyan mt-1">
                    U.S. provisional 63/934,269
                  </p>
                )}
                {metric.label === "PROPOSED PROCESS STEPS" && (
        ...
        {/* Concept Renders */}
        <section className="container mx-auto px-4 py-16 border-t border-border">
          <p className="text-xs font-mono text-[#d8aa43]/60 tracking-[0.2em] uppercase mb-8">
            Conceptual Visualization — Research Direction
          </p>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              <img
                ...
                alt="Energy transfer visualization concept"
            ...
            >
              <img
                ...
                alt="Lattice structure visualization concept"
                className="w-full h-64 object-cover"
                style={{ filter: "brightness(0.85) saturate(0.9)" }}
              />
            </motion.div>
          ...
          <p className="text-xs font-mono text-muted-foreground mt-4">
            Conceptual AI renders for research communication purposes only. Not
            photographs of actual materials or devices.
          </p>
        </section>
      </div>
    </div>
