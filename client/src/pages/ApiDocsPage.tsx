      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-4 mt-4">
            <span className="text-xs bg-[#d6a33a]/20 text-[#d6a33a] px-3 py-1 rounded-full">
              v{docs?.version}
            </span>
            <span className="text-xs bg-white/10 text-white/60 px-3 py-1 rounded-full font-mono">
              {docs?.baseUrl}
            </span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              onClick={() =>
                copyToClipboard(
                  (codeExamples as any)[activeExample] ?? "",
                  "example"
                )
              }
            ...
            {endpoints.map((endpoint: any, i: number) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`text-xs px-2 py-0.5 rounded-full ${authColors[endpoint.auth] ?? authColors.none}`}
                  >
                    {endpoint.auth}
                  </span>
                      ...
                      <div className="mt-3">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {endpoint.params.map((param: string) => (
                            <code
                              key={param}
                              className="text-xs bg-white/10 text-[#d6a33a] px-2 py-0.5 rounded font-mono"
                            >
                              {param}
                            </code>
                          ))}
