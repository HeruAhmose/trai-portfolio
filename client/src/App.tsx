...
const HomeCinematic = lazy(() =>
  import("./pages/HomeCinematic").then(m => ({ default: m.HomeCinematic }))
);
...
const AdvancedFeatures = lazy(() =>
  import("./pages/AdvancedFeatures").then(m => ({
    default: m.AdvancedFeatures,
  }))
);
...
const SoundPreferencesPage = lazy(() =>
  import("./pages/SoundPreferencesPage").then(m => ({
    default: m.SoundPreferencesPage,
  }))
);
...
const AdvancedFeaturesShowcase = lazy(() =>
  import("./pages/AdvancedFeaturesShowcase").then(m => ({
    default: m.AdvancedFeaturesShowcase,
  }))
);
import { useSessionId } from "./hooks/useSessionId";

const ENABLE_LABS = import.meta.env.VITE_ENABLE_LABS === "true";
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        {ENABLE_LABS && <Route path="/search" component={SearchPage} />}
        {ENABLE_LABS && <Route path="/api-docs" component={ApiDocsPage} />}
        {ENABLE_LABS && (
              ...
              <TooltipProvider>
                ...
                <>
                  <PremiumNavigation
                    ...
                    sessionId={ENABLE_LABS ? sessionId : ""}
                  />
