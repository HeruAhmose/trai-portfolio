    ...
    <div className="w-full max-w-2xl mx-auto p-6 bg-gradient-to-b from-black/50 to-black/20 rounded-lg border border-cyan-400/30">
      ...
      >
        <h3 className="text-lg font-bold text-cyan-400 mb-4 text-center">
          Illustrative Quantum-State Simulation (Bloch Sphere)
        </h3>
        ...
        <div className="mt-6 p-4 bg-black/50 rounded border border-cyan-400/20">
          <h4 className="text-sm font-bold text-cyan-400 mb-2">
            Research Targets — Not Measured
          </h4>
          <div className="text-xs text-gold-400 space-y-1 font-mono">
            <div>Coherence hypothesis: &gt;500 ns at 300 K</div>
            <div>Research range: 1–10 μs — target, not confirmed</div>
            <div>Gate fidelity: illustrative control only — not measured</div>
            <div>
              Entanglement entropy: illustrative control only — not measured
            </div>
            <div>
              Evidence base: 51 peer-reviewed papers cited for constituent
              mechanisms
            </div>
          </div>
        </div>
