      ...
      >
        <defs>
          <filter id={`glow-${color}`} x="-50%" y="-50%" width="200%" height="200%">
            <feGaussianBlur stdDeviation={intensitySettings.glowBlur} result="coloredBlur" />
            <feMerge>
        ...
        <path
          ...
          style={{
            animation: animated ? `neon-pulse-${color} 2s ease-in-out infinite` : 'none',
          }}
        />
        ...
        <path
          ...
          filter={`url(#glow-${color})`}
          style={{
            animation: animated ? `holographic-shimmer 3s ease-in-out infinite` : 'none',
            mixBlendMode: 'screen',
          }}
        />
      </svg>
