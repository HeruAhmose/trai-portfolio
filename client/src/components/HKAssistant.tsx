      ...
      {isOpen && (
        <>
          <motion.button
            ...
            onClick={onClose}
            className="fixed inset-0 z-[2147482450] bg-black/65 sm:hidden"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          />
          <motion.div
            ...
            className="fixed bottom-20 left-3 right-3 z-[2147482500] flex w-auto flex-col rounded-xl border border-[#d6a33a]/30 bg-[#0a0d10] shadow-2xl sm:left-auto sm:right-4 sm:w-96"
            style={{
