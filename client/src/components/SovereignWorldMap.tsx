...
const REGIONS: Region[] = [
  ...
  { id: 1, name: 'Saffron Gardens', role: 'Heart', organ: 'True Mélange Φ', desc: 'Saffron-hemp biotechnology platform. First product: Blue-Gold Daily RTD tea. Biological sovereignty — what the organism metabolizes.', route: '/true-melange', x: 48, y: 30, color: '#d8aa43', glyph: 'Φ' },
