...
const REGIONS: Region[] = [
  {
    ...
    name: "Carbon Forge",
    role: "Skeleton",
    organ: "Tamerian Materials",
    desc: "Bio-derived multifunctional composites for self-powered sensing. U.S. provisional App 63/934,269; integrated performance remains unvalidated.",
    route: "/materials",
  ...
  {
    id: 1,
    name: "Saffron Gardens",
    role: "Heart",
    organ: "True Mélange Φ",
    desc: "Saffron-hemp biotechnology platform. First product: Blue-Gold Daily RTD tea. Biological sovereignty — what the organism metabolizes.",
    route: "/true-melange",
    x: 48,
    y: 30,
    color: "#d8aa43",
  ...
  {
    id: 2,
    name: "Blue Cyber Citadel",
    role: "Brain",
    organ: "Queen Califia",
    desc: "Human-authorized, evidence-bound cybersecurity command demo. Triple-core: Cyber, Identity, Markets.",
    route: "/queen-califia",
  ...
  {
    id: 3,
    name: "Caravan Arteries",
    role: "Vessels",
    organ: "Mela Nation",
    desc: "Last-mile logistics, community access, resilient distribution. Mobility sovereignty — the blood vessels of the organism.",
    route: "/mela-nation",
    x: 78,
    y: 55,
    color: "#e85d3a",
  ...
  {
    id: 4,
    name: "Woven Identity Coast",
    role: "Skin",
    organ: "MeLaNiNa",
    desc: "Hemp apparel, cultural expression, employee-ownership pathways. Identity sovereignty — the skin that carries memory.",
    route: "/melanina",
    x: 55,
    y: 68,
    color: "#9b59b6",
  ...
  {
    id: 5,
    name: "Digital Bridge Delta",
    role: "Hands",
    organ: "TechBridge",
    desc: "Planned Digital Navigator hubs with deterministic H.K. triage. Community reach — the hands designed to build bridges.",
    route: "/community",
...
export function SovereignWorldMap({
  ...
  useEffect(() => {
    ...
    CONNECTIONS.filter(([a, b]) => a === active || b === active).forEach(
      ([a, b]) => {
        const ra = REGIONS[a],
          rb = REGIONS[b];
        const x1 = (ra.x / 100) * W,
    ...
    <div className="relative w-full" style={{ minHeight: 520 }}>
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: isActive
                  ? `0 0 20px ${r.color}60, 0 0 40px ${r.color}20`
                  : "none",
              }}
              animate={
                isActive
            ...
            <span
              ...
              style={{
                color: isActive ? r.color : "rgba(244,240,230,0.35)",
                textShadow: isActive ? `0 0 12px ${r.color}80` : "none",
              }}
            >
              {r.role}
            </span>
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(0deg, rgba(5,7,9,0.97) 60%, transparent)",
          }}
            ...
            <div className="flex gap-2 flex-shrink-0 mt-1">
              <motion.button
                ...
                whileHover={{
                  ...
                  background: `${activeRegion.color}15`,
                }}
                whileTap={{ scale: 0.96 }}
              >
                Enter →
