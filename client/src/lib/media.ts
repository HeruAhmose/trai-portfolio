 ...
 * site already distinguishes built systems from early-development ventures; this does
...
export const TECHNOLOGIES: Technology[] = [
  ...
  },
  {
    ...
    body: "A human-authorized, evidence-bound cybersecurity command-surface concept spanning Cyber, Identity, and Markets. The public experience is a demo, not an autonomous operator or production security service.",
    stage: "Public demo · active development",
    media: TAMERIAN[5],
  },
  {
    name: "Tameric Syntax",
