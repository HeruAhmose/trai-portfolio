...
| 02  | Heart — biological sovereignty  | True Melange Φ         | Formulation set · entity pending | own repo: [blue-gold-daily](https://github.com/HeruAhmose/blue-gold-daily) → [blue-gold-daily site](https://heruahmose.github.io/blue-gold-daily/layers.html) · deeper content here: [`/true-melange`](client/src/pages/TrueMelangePhi.tsx) |
